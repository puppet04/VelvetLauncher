...
async function showMainUI(data) {
    ...
    setTimeout(() => {
        ...
        const bkid = document.body.getAttribute('bkid') || '0.jpg'
        const bgImage = bkid.includes('.') ? bkid : `${bkid}.jpg`
        document.body.style.backgroundImage = `url('assets/images/backgrounds/${bgImage}')`
        $('#main').show()
